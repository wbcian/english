...
| 片語 | 意思 |
|---|---|
| cram (sth) into (sth) | 把...塞進... |
| cram for an exam / a test | 為考試臨時抱佛腳 |
| crammed with... | 塞滿了...（被動 / 形容詞用法） |
| cram school ⭐ | 補習班（台灣學生熟字） |

## 形容詞 crammed = 塞爆的、擁擠的

> "a crammed train" — 爆滿的電車
> "a crammed schedule" — 塞爆的行程
> "The closet is crammed with old clothes." — 衣櫃塞滿舊衣服。
...
## Synonyms
- 塞滿：stuff, pack, jam, squeeze, wedge
- K 書：bone up on, swot (英式), study intensively, pull an all-nighter
