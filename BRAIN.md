...
## 快照（隨更新同步）
- 已收錄單字：272
- 5★ 精熟：0　 3–4★ 學習中：8　 1–2★ 新／脆弱：264
- 最近活動日期：2026-07-23（📚 **新增單字：role**——Cian 問面試開場句 "What are you looking for in your next role?" 裡 role 的意思。重點是「職位/職務」的正式說法（比 job 文雅、面試履歷常用），招牌句型 `in your next role`；⚠️ 同音字 `roll` 別搞混。★1，雙語 karaoke 例句＋ `_index` 同步。詞庫 271→**272**）
