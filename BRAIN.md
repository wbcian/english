...
## 快照（隨更新同步）
- 已收錄單字：281（**全部標了 `cefr` + `frequency` 雙軸**）
- 5★ 精熟：0　 3–4★ 學習中：8　 1–2★ 新／脆弱：273
- CEFR 分佈：A2 22 · B1 70 · B2 158 · C1 29 · C2 2　｜　常見度：高頻 25 · 中頻 143 · 低頻 113　｜　41 字帶 `?`（估計/邊界）
- 最近活動日期：2026-07-24（📚 **單字批次練習：dismayed / utterly / colonial power / in a negative light / fester**——第一批套用新雙軸標記。⚠️ 修掉 Cian 的搭配錯誤 `project in a negative light`（light 配 cast／portray，`project` 配 image）；另兩個文法陷阱：`dismayed` 只能被動、`fester` 不及物。詞庫 276→**281**）
