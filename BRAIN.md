...
## 快照（隨更新同步）
- 已收錄單字：152
- 5★ 精熟：0　 3–4★ 學習中：8　 1–2★ 新／脆弱：144
- 最近活動日期：2026-06-23（🎧 **新 lesson：《The Devil Wears Prada》— Miranda 的地獄級第一天**（dialogue · B2）＋ 📚 **新增 11 個單字／片語**：skimmed milk、drip coffee、run errands、deal with it、fling、foam、man（動詞）、searing、chained to、on the line、on the chopping block。依 RealLife English / Ksenia 字幕截圖整理咖啡訂單、辦公室值守、跑腿分工與工作風險；全 ★1，建檔＋雙語例句＋ `_index.md` 同步，並做 `on the line` vs `on the chopping block` 辨析。詞庫 141→152）
