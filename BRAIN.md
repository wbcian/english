...
## 快照（隨更新同步）
- 已收錄單字：248
- 5★ 精熟：0　 3–4★ 學習中：8　 1–2★ 新／脆弱：240
- 最近活動日期：2026-07-14（📚 **中翻英辨析＋新增單字：「素材」怎麼講**——Cian 問「素材」的英文，拆成四個依情境分工的字：**material**（泛用）、**footage**（限影像素材）、**content**（行銷/社群語境，⚠️重音陷阱）、**source material**（改編作品的原著）。另 📚 **新增單字：merchant** /ˈmɜːrtʃənt/（n.，商人、貿易商）——語感偏傳統/大宗貿易商，現代延伸見於電商 online merchant、merchant account。全 ★1，雙語 karaoke 例句＋ `_index` 同步。詞庫 243→**248**）
