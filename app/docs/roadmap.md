...
- **單字排序優化 + 熱點圖**：vocab 列表排序調整（目前排序邏輯待優化）＋「單字熱點圖」視覺化學習熱點。**低優先位**——M06（2026-07-03/04 定調）已明確英文 app 停大功能開發、只降摩擦（reduce friction），此項排隊觀察，非近期排程。來源：daily-journal W27, 2026-07-02。
